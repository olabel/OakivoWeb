...
export const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    outcomes: {
      ...
      proof_desc: "Oakivo builds and maintains production billing automation platforms running in live environments—modular architecture, automated deployment, and real-time alerting. This is the same reliability discipline applied to every audit.",
      proof_pillar1_title: "Modular Architecture",
      proof_pillar1_desc: "Decoupled connectors built to scale smoothly across QuickBooks, Xero & Sage.",
      proof_pillar2_title: "Automated Deployment",
      proof_pillar2_desc: "Zero-downtime sandbox testing before pushing live billing sync integrations.",
      proof_pillar3_title: "Real-Time Alerting",
      proof_pillar3_desc: "Instant notification and fallback logging if an upstream accounting API encounters issues.",
      security_title: "Security & Compliance Standards",
      security1_title: "Data Encryption",
      security1_desc: "TLS 1.3 in-transit and 256-Bit AES encryption at rest across all automated invoice pipelines.",
      security2_title: "API Security Standards",
      security2_desc: "OAuth 2.0 tokenized accounting access—your master credentials are never stored or exposed.",
      security3_title: "Regional Compliance",
      security3_desc: "PIPEDA compliant with Canadian data sovereignty hosted securely in local Cloud regions."
    },
    drawer: {
  ...
  fr: {
    ...
    outcomes: {
      ...
      proof_desc: "Oakivo conçoit et maintient des plateformes d'automatisation de facturation en environnement de production réel—architecture modulaire, déploiement automatisé et alertes en temps réel. C'est la même discipline de fiabilité appliquée à chaque audit.",
      proof_pillar1_title: "Architecture Modulaire",
      proof_pillar1_desc: "Connecteurs découplés conçus pour s'adapter à QuickBooks, Xero et Sage.",
      proof_pillar2_title: "Déploiement Automatisé",
      proof_pillar2_desc: "Tests en environnement bac à sable sans interruption avant la mise en service.",
      proof_pillar3_title: "Alertes en Temps Réel",
      proof_pillar3_desc: "Notifications instantanées si une API comptable rencontre un problème.",
      security_title: "Normes de Sécurité et de Conformité",
      security1_title: "Chiffrement des Données",
      security1_desc: "Chiffrement TLS 1.3 en transit et AES-256 au repos sur tous les flux de factures.",
      security2_title: "Normes de Sécurité des API",
      security2_desc: "Accès comptable sécurisé par jeton OAuth 2.0—vos identifiants ne sont jamais stockés ni exposés.",
      security3_title: "Conformité Régionale",
      security3_desc: "Conforme à la LPRPDE avec souveraineté des données canadiennes hébergées localement."
    },
    drawer: {
