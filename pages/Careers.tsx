      ...
      <Section className="bg-slate-900 text-white py-24 border-t border-white/10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 text-cyan-400 font-mono font-bold uppercase tracking-widest text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {careersData.values.map((val: any, idx: number) => (
                <div key={idx} className="bg-slate-900/40 backdrop-blur-md rounded-sm border border-slate-800 rounded-2xl p-6 border border-white/[0.08] space-y-3">
          ...
          <div className="bg-slate-900/40 backdrop-blur-md rounded-sm border border-slate-800 rounded-3xl p-8 border border-white/10 space-y-6">
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="text-[10px] font-mono uppercase text-gray-400 block mb-1">Full Name *</label>
                ...
                <div>
                  <label className="text-[10px] font-mono uppercase text-gray-400 block mb-1">Work Email *</label>
                ...
                <div>
                  <label className="text-[10px] font-mono uppercase text-gray-400 block mb-1">LinkedIn / Portfolio URL</label>
                ...
                <div>
                  <label className="text-[10px] font-mono uppercase text-gray-400 block mb-1">Background Summary</label>
